 ...
 *
 * @author Philipp Scholl & Jan Schneider
 * @since 27.05.2019
 *
 */
    ...
    public void init()
    {
        ...
        try
        {
            ...
            try{
                ...
                final InputStream file = context.getAssets().open("portConfig.txt");
                ...
                TCPSenderPort = Integer.parseInt(text[0]);
                TCPListenerPort = Integer.parseInt(text[1]);
                TCPFilePort = Integer.parseInt(text[2]);
                UDPSenderPort = Integer.parseInt(text[3]);
                UDPListenerPort = Integer.parseInt(text[5]);
                HupIPAddress = text[5];
